...
def train_gan(generator, discriminator, dataloader, num_epochs=100):
    ...
    for epoch in range(num_epochs):
        for batch_idx, (real_images, _) in enumerate(dataloader):
            ...
            real_labels = torch.ones(batch_size, 1)  # Real images labeled as 1
            fake_labels = torch.zeros(batch_size, 1)  # Fake images labeled as 0
...
if __name__ == "__main__":
    # Setting up data for training (MNIST dataset as an example)
